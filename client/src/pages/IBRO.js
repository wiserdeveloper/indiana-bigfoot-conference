                         ...
                         <div className="ibro-members-content">
                              ...
                              <div className="ibro-member">
                                   ...
                                   <div className="ibro-text">
                                        <h3>LeRoy & Nancy</h3>
                                        <p>We are the owners and operators of the IBRO. We are so blessed to have such wonderful people that we can call our friends and researchers. We have been researching for over ten years. We have been running the IBRO since the spring of 2014. With each passing year, we gain more researchers and the group continues to grow. Please feel free to contact me at any time with any questions.</p>
                                   </div>
                              </div>
                              ...
                              <div className="ibro-member">
                                   ...
                                   <div className="ibro-text">
                                        <h3>Ed Blakley</h3>
                                        <p>Ed has spent a lot of time researching over the past ten years. Because he is such a good tracker, a number of the foot casting that we show during our presentations are a direct result of Ed finding the footprints. Ed continues to bring a lot for the IBRO and a valued member of our researchers.</p>
                                   </div>
                              </div>
